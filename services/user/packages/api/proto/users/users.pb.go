...
var file_users_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8e, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e,
	...
	,
...
var file_users_proto_depIdxs = []int32{
	2, // 0: users.User.created_at:type_name -> google.protobuf.Timestamp
	2, // 1: users.User.updated_at:type_name -> google.protobuf.Timestamp
	0, // 2: users.UserService.Create:input_type -> users.User
	1, // 3: users.UserService.Retrieve:input_type -> users.UserID
	0, // 4: users.UserService.Create:output_type -> users.User
	0, // 5: users.UserService.Retrieve:output_type -> users.User
...
type UserServiceClient interface {
	...
	Retrieve(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*User, error)
}
...
func (c *userServiceClient) Retrieve(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/users.UserService/Retrieve", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	// retrieves an existing user
	Retrieve(context.Context, *UserID) (*User, error)
}
...
func (*UnimplementedUserServiceServer) Retrieve(context.Context, *UserID) (*User, error) {
...
func _UserService_Retrieve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.UserService/Retrieve",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Retrieve(ctx, req.(*UserID))
	}
	return interceptor(ctx, in, info, handler)
}
